...
<BODY>
<FORM id=form1 name=form1 action="UserAction_login"  method=post>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD><INPUT id=btn 
                  ...
                  <TD><img style="cursor: pointer;" onclick="window.location='${pageContext.request.contextPath}/regist.jsp'"  src="images/regist_button.png" /></TD>
