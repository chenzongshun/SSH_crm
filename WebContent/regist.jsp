...
<script type="text/javascript">
	window.onload = function(){
		if (window.parent != window) {//判断页面的父窗口，如果不等于最大的，那就让父窗口等于...
...
<BODY>
<FORM id=form1 name=form1 action="UserAction_regist"  method=post>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD><a style="cursor: pointer;" onclick="window.location='${pageContext.request.contextPath}/login.jsp'"  src="images/login_button.gif" >我要去登陆</a></TD>
