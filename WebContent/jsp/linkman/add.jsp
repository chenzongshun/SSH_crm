...
<s:property value="lKm_id==null?'添加':'修改'" />
联系人</TITLE> 
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; 
								<s:property value="lKm_id==null?'添加':'修改'" />联系人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
								<input type="hidden" name="customer.cust_id"  id="cust_id" style="WIDTH: 180px"/>
								<input type="text" id="cust_name" name="cust_name" style="WIDTH: 180px" value="<s:property value="#linkman.customer.cust_name" />"/>
								<input type="button" value="选择一个联系人" onclick="window.open('${pageContext.request.contextPath }/CustomerAction_list?select=true','width=800','heigth=550')"/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								...
								<input type="hidden" name="lkm_id" value="<s:property value="lKm_id" />" />
								<s:if test="#gender==1">
									<input type="radio" value="1" checked name="lkm_gender"   >男
									<input type="radio" value="2"   name="lkm_gender"    >女
								</s:if>
								<s:else>
									<input type="radio" value="1" name="lkm_gender"   >男
									<input type="radio" value="2"  checked name="lkm_gender"    >女
								</s:else>
