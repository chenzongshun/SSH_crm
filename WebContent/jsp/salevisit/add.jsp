...
<LINK href="${pageContext.request.contextPath }/css/Style.css" type=text/css rel=stylesheet>
<LINK href="${pageContext.request.contextPath }/js/datepicker17sucaiwang/laydate.css" type=text/css
	rel=stylesheet>
<!-- 使用日期控件步骤1: 导入js和css -->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/js/datepicker17sucaiwang/laydate.js"></script>
...
<!-- 
 ...
 -->
								...
								<td>下次拜访时间：</td>
								<td>
		  <%-- <INPUT class=textbox id="visit_nexttime" readonly="readonly" style="WIDTH: 180px" maxLength=50 name="visit_nexttime" value="<s:property value="#saleVisit.visit_nexttime_s" />">   --%>
																	<div class="box">
									<div class="demo3">
										<ul class="inline">
											<%-- <li class="textbox"  class="inline laydate-icon" id="end" name="visit_nexttime"  style="width:180px; list-style: none; margin-left: -40px"  ><s:property value="#saleVisit.visit_nexttime_s" /></li> --%> 
								        <INPUT class="textbox"  class="inline laydate-icon"   id="end"  readonly="readonly" style="WIDTH: 180px;margin-left: -40px" maxLength=50 name="visit_nexttime" value="<s:property value="#saleVisit.visit_nexttime_s" />"> 
										</ul>
									</div>
								</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/datepicker17sucaiwang/datemy.js"></script>
</BODY>
</HTML>
